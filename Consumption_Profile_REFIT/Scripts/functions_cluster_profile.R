...
correlacao_20U <- function(user1,user2,user3,user4,user5,user6,user7,user8,user9,user10,
  ...
  # User 1
  corr[1,2] <- cor(user1[,2], user2[,2], method = "pearson")
  corr[1,3] <- cor(user1[,2], user3[,2], method = "pearson")
  corr[1,4] <- cor(user1[,2], user4[,2], method = "pearson")
  corr[1,5] <- cor(user1[,2], user5[,2], method = "pearson")
  corr[1,6] <- cor(user1[,2], user6[,2], method = "pearson")
  corr[1,7] <- cor(user1[,2], user7[,2], method = "pearson")
  corr[1,8] <- cor(user1[,2], user8[,2], method = "pearson")
  corr[1,9] <- cor(user1[,2], user9[,2], method = "pearson")
  corr[1,10] <- cor(user1[,2], user10[,2], method = "pearson")
  corr[1,11] <- cor(user1[,2], user11[,2], method = "pearson")
  corr[1,12] <- cor(user1[,2], user12[,2], method = "pearson")
  corr[1,13] <- cor(user1[,2], user13[,2], method = "pearson")
  corr[1,14] <- cor(user1[,2], user14[,2], method = "pearson")
  corr[1,15] <- cor(user1[,2], user15[,2], method = "pearson")
  corr[1,16] <- cor(user1[,2], user16[,2], method = "pearson")
  corr[1,17] <- cor(user1[,2], user17[,2], method = "pearson")
  corr[1,18] <- cor(user1[,2], user18[,2], method = "pearson")
  corr[1,19] <- cor(user1[,2], user19[,2], method = "pearson")
  corr[1,20] <- cor(user1[,2], user20[,2], method = "pearson")
  
  # User 2
  corr[2,3] <- cor(user2[,2], user3[,2], method = "pearson")
  corr[2,4] <- cor(user2[,2], user4[,2], method = "pearson")
  corr[2,5] <- cor(user2[,2], user5[,2], method = "pearson")
  corr[2,6] <- cor(user2[,2], user6[,2], method = "pearson")
  corr[2,7] <- cor(user2[,2], user7[,2], method = "pearson")
  corr[2,8] <- cor(user2[,2], user8[,2], method = "pearson")
  corr[2,9] <- cor(user2[,2], user9[,2], method = "pearson")
  corr[2,10] <- cor(user2[,2], user10[,2], method = "pearson")
  corr[2,11] <- cor(user2[,2], user11[,2], method = "pearson")
  corr[2,12] <- cor(user2[,2], user12[,2], method = "pearson")
  corr[2,13] <- cor(user2[,2], user13[,2], method = "pearson")
  corr[2,14] <- cor(user2[,2], user14[,2], method = "pearson")
  corr[2,15] <- cor(user2[,2], user15[,2], method = "pearson")
  corr[2,16] <- cor(user2[,2], user16[,2], method = "pearson")
  corr[2,17] <- cor(user2[,2], user17[,2], method = "pearson")
  corr[2,18] <- cor(user2[,2], user18[,2], method = "pearson")
  corr[2,19] <- cor(user2[,2], user19[,2], method = "pearson")
  corr[2,20] <- cor(user2[,2], user20[,2], method = "pearson")
  
  # User 3
  corr[3,4] <- cor(user3[,2], user4[,2], method = "pearson")
  corr[3,5] <- cor(user3[,2], user5[,2], method = "pearson")
  corr[3,6] <- cor(user3[,2], user6[,2], method = "pearson")
  corr[3,7] <- cor(user3[,2], user7[,2], method = "pearson")
  corr[3,8]  <- cor(user3[,2], user8[,2], method = "pearson")
  corr[3,9] <- cor(user3[,2], user9[,2], method = "pearson")
  corr[3,10] <- cor(user3[,2], user10[,2], method = "pearson")
  corr[3,11] <- cor(user3[,2], user11[,2], method = "pearson")
  corr[3,12] <- cor(user3[,2], user12[,2], method = "pearson")
  corr[3,13] <- cor(user3[,2], user13[,2], method = "pearson")
  corr[3,14] <- cor(user3[,2], user14[,2], method = "pearson")
  corr[3,15] <- cor(user3[,2], user15[,2], method = "pearson")
  corr[3,16] <- cor(user3[,2], user16[,2], method = "pearson")
  corr[3,17] <- cor(user3[,2], user17[,2], method = "pearson")
  corr[3,18] <- cor(user3[,2], user18[,2], method = "pearson")
  corr[3,19] <- cor(user3[,2], user19[,2], method = "pearson")
  corr[3,20] <- cor(user3[,2], user20[,2], method = "pearson")
  
  # User 4
  corr[4,5] <- cor(user4[,2], user5[,2], method = "pearson")
  corr[4,6] <- cor(user4[,2], user6[,2], method = "pearson")
  corr[4,7] <- cor(user4[,2], user7[,2], method = "pearson")
  corr[4,8] <- cor(user4[,2], user8[,2], method = "pearson")
  corr[4,9] <- cor(user4[,2], user9[,2], method = "pearson")
  corr[4,10] <- cor(user4[,2], user10[,2], method = "pearson")
  corr[4,11] <- cor(user4[,2], user11[,2], method = "pearson")
  corr[4,12] <- cor(user4[,2], user12[,2], method = "pearson")
  corr[4,13] <- cor(user4[,2], user13[,2], method = "pearson")
  corr[4,14] <- cor(user4[,2], user14[,2], method = "pearson")
  corr[4,15] <- cor(user4[,2], user15[,2], method = "pearson")
  corr[4,16] <- cor(user4[,2], user16[,2], method = "pearson")
  corr[4,17] <- cor(user4[,2], user17[,2], method = "pearson")
  corr[4,18] <- cor(user4[,2], user18[,2], method = "pearson")
  corr[4,19] <- cor(user4[,2], user19[,2], method = "pearson")
  corr[4,20] <- cor(user4[,2], user20[,2], method = "pearson")
  
  # User 5
  corr[5,6] <- cor(user5[,2], user6[,2], method = "pearson")
  corr[5,7] <- cor(user5[,2], user7[,2], method = "pearson")
  corr[5,8] <- cor(user5[,2], user8[,2], method = "pearson")
  corr[5,9] <- cor(user5[,2], user9[,2], method = "pearson")
  corr[5,10] <- cor(user5[,2], user10[,2], method = "pearson")
  corr[5,11] <- cor(user5[,2], user11[,2], method = "pearson")
  corr[5,12] <- cor(user5[,2], user12[,2], method = "pearson")
  corr[5,13] <- cor(user5[,2], user13[,2], method = "pearson")
  corr[5,14] <- cor(user5[,2], user14[,2], method = "pearson")
  corr[5,15] <- cor(user5[,2], user15[,2], method = "pearson")
  corr[5,16] <- cor(user5[,2], user16[,2], method = "pearson")
  corr[5,17] <- cor(user5[,2], user17[,2], method = "pearson")
  corr[5,18] <- cor(user5[,2], user18[,2], method = "pearson")
  corr[5,19] <- cor(user5[,2], user19[,2], method = "pearson")
  corr[5,20] <- cor(user5[,2], user20[,2], method = "pearson")
  
  # User 6
  corr[6,7] <- cor(user6[,2], user7[,2], method = "pearson")
  corr[6,8] <- cor(user6[,2], user8[,2], method = "pearson")
  corr[6,9] <- cor(user6[,2], user9[,2], method = "pearson")
  corr[6,10] <- cor(user6[,2], user10[,2], method = "pearson")
  corr[6,11] <- cor(user6[,2], user11[,2], method = "pearson")
  corr[6,12] <- cor(user6[,2], user12[,2], method = "pearson")
  corr[6,13] <- cor(user6[,2], user13[,2], method = "pearson")
  corr[6,14] <- cor(user6[,2], user14[,2], method = "pearson")
  corr[6,15] <- cor(user6[,2], user15[,2], method = "pearson")
  corr[6,16] <- cor(user6[,2], user16[,2], method = "pearson")
  corr[6,17] <- cor(user6[,2], user17[,2], method = "pearson")
  corr[6,18] <- cor(user6[,2], user18[,2], method = "pearson")
  corr[6,19] <- cor(user6[,2], user19[,2], method = "pearson")
  corr[6,20] <- cor(user6[,2], user20[,2], method = "pearson")
  
  # User 7
  corr[7,8] <- cor(user7[,2], user8[,2], method = "pearson")
  corr[7,9] <- cor(user7[,2], user9[,2], method = "pearson")
  corr[7,10] <- cor(user7[,2], user10[,2], method = "pearson")
  corr[7,11] <- cor(user7[,2], user11[,2], method = "pearson")
  corr[7,12] <- cor(user7[,2], user12[,2], method = "pearson")
  corr[7,13] <- cor(user7[,2], user13[,2], method = "pearson")
  corr[7,14] <- cor(user7[,2], user14[,2], method = "pearson")
  corr[7,15] <- cor(user7[,2], user15[,2], method = "pearson")
  corr[7,16] <- cor(user7[,2], user16[,2], method = "pearson")
  corr[7,17] <- cor(user7[,2], user17[,2], method = "pearson")
  corr[7,18] <- cor(user7[,2], user18[,2], method = "pearson")
  corr[7,19] <- cor(user7[,2], user19[,2], method = "pearson")
  corr[7,20] <- cor(user7[,2], user20[,2], method = "pearson")
  
  # User 8
  corr[8,9] <- cor(user8[,2], user9[,2], method = "pearson")
  corr[8,10] <- cor(user8[,2], user10[,2], method = "pearson")
  corr[8,11] <- cor(user8[,2], user11[,2], method = "pearson")
  corr[8,12] <- cor(user8[,2], user12[,2], method = "pearson")
  corr[8,13] <- cor(user8[,2], user13[,2], method = "pearson")
  corr[8,14] <- cor(user8[,2], user14[,2], method = "pearson")
  corr[8,15] <- cor(user8[,2], user15[,2], method = "pearson")
  corr[8,16] <- cor(user8[,2], user16[,2], method = "pearson")
  corr[8,17] <- cor(user8[,2], user17[,2], method = "pearson")
  corr[8,18] <- cor(user8[,2], user18[,2], method = "pearson")
  corr[8,19] <- cor(user8[,2], user19[,2], method = "pearson")
  corr[8,20] <- cor(user8[,2], user20[,2], method = "pearson")
  
  # User 9
  corr[9,10] <- cor(user9[,2], user10[,2], method = "pearson")
  corr[9,11] <- cor(user9[,2], user11[,2], method = "pearson")
  corr[9,12] <- cor(user9[,2], user12[,2], method = "pearson")
  corr[9,13] <- cor(user9[,2], user13[,2], method = "pearson")
  corr[9,14] <- cor(user9[,2], user14[,2], method = "pearson")
  corr[9,15] <- cor(user9[,2], user15[,2], method = "pearson")
  corr[9,16] <- cor(user9[,2], user16[,2], method = "pearson")
  corr[9,17] <- cor(user9[,2], user17[,2], method = "pearson")
  corr[9,18] <- cor(user9[,2], user18[,2], method = "pearson")
  corr[9,19] <- cor(user9[,2], user19[,2], method = "pearson")
  corr[9,20] <- cor(user9[,2], user20[,2], method = "pearson")
  
  # User 10
  corr[10,11] <- cor(user10[,2], user11[,2], method = "pearson")
  corr[10,12] <- cor(user10[,2], user12[,2], method = "pearson")
  corr[10,13] <- cor(user10[,2], user13[,2], method = "pearson")
  corr[10,14] <- cor(user10[,2], user14[,2], method = "pearson")
  corr[10,15] <- cor(user10[,2], user15[,2], method = "pearson")
  corr[10,16] <- cor(user10[,2], user16[,2], method = "pearson")
  corr[10,17] <- cor(user10[,2], user17[,2], method = "pearson")
  corr[10,18] <- cor(user10[,2], user18[,2], method = "pearson")
  corr[10,19] <- cor(user10[,2], user19[,2], method = "pearson")
  corr[10,20] <- cor(user10[,2], user20[,2], method = "pearson")
  
  # User 11
  corr[11,12] <- cor(user11[,2], user12[,2], method = "pearson")
  corr[11,13] <- cor(user11[,2], user13[,2], method = "pearson")
  corr[11,14] <- cor(user11[,2], user14[,2], method = "pearson")
  corr[11,15] <- cor(user11[,2], user15[,2], method = "pearson")
  corr[11,16] <- cor(user11[,2], user16[,2], method = "pearson")
  corr[11,17] <- cor(user11[,2], user17[,2], method = "pearson")
  corr[11,18] <- cor(user11[,2], user18[,2], method = "pearson")
  corr[11,19] <- cor(user11[,2], user19[,2], method = "pearson")
  corr[11,20] <- cor(user11[,2], user20[,2], method = "pearson")
  
  # User 12
  corr[12,13] <- cor(user12[,2], user13[,2], method = "pearson")
  corr[12,14] <- cor(user12[,2], user14[,2], method = "pearson")
  corr[12,15] <- cor(user12[,2], user15[,2], method = "pearson")
  corr[12,16] <- cor(user12[,2], user16[,2], method = "pearson")
  corr[12,17] <- cor(user12[,2], user17[,2], method = "pearson")
  corr[12,18] <- cor(user12[,2], user18[,2], method = "pearson")
  corr[12,19] <- cor(user12[,2], user19[,2], method = "pearson")
  corr[12,20] <- cor(user12[,2], user20[,2], method = "pearson")
  
  # User 13
  corr[13,14] <- cor(user13[,2], user14[,2], method = "pearson")
  corr[13,15] <- cor(user13[,2], user15[,2], method = "pearson")
  corr[13,16] <- cor(user13[,2], user16[,2], method = "pearson")
  corr[13,17] <- cor(user13[,2], user17[,2], method = "pearson")
  corr[13,18] <- cor(user13[,2], user18[,2], method = "pearson")
  corr[13,19] <- cor(user13[,2], user19[,2], method = "pearson")
  corr[13,20] <- cor(user13[,2], user20[,2], method = "pearson")
  
  # User 14
  corr[14,15] <- cor(user14[,2], user15[,2], method = "pearson")
  corr[14,16] <- cor(user14[,2], user16[,2], method = "pearson")
  corr[14,17] <- cor(user14[,2], user17[,2], method = "pearson")
  corr[14,18] <- cor(user14[,2], user18[,2], method = "pearson")
  corr[14,19] <- cor(user14[,2], user19[,2], method = "pearson")
  corr[14,20] <- cor(user14[,2], user20[,2], method = "pearson")
  
  # User 15
  corr[15,16] <- cor(user15[,2], user16[,2], method = "pearson")
  corr[15,17] <- cor(user15[,2], user17[,2], method = "pearson")
  corr[15,18] <- cor(user15[,2], user18[,2], method = "pearson")
  corr[15,19] <- cor(user15[,2], user19[,2], method = "pearson")
  corr[15,20] <- cor(user15[,2], user20[,2], method = "pearson")
  
  # User 16
  corr[16,17] <- cor(user16[,2], user17[,2], method = "pearson")
  corr[16,18] <- cor(user16[,2], user18[,2], method = "pearson")
  corr[16,19] <- cor(user16[,2], user19[,2], method = "pearson")
  corr[16,20] <- cor(user16[,2], user20[,2], method = "pearson")
  
  # User 17
  corr[17,18] <- cor(user17[,2], user18[,2], method = "pearson")
  corr[17,19] <- cor(user17[,2], user19[,2], method = "pearson")
  corr[17,20] <- cor(user17[,2], user20[,2], method = "pearson")
  
  # User 18
  corr[18,19] <- cor(user18[,2], user19[,2], method = "pearson")
  corr[18,20] <- cor(user18[,2], user20[,2], method = "pearson")
  
  # User 19
  corr[19,20] <- cor(user19[,2], user20[,2], method = "pearson")
